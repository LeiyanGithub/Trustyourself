...
# CUDA_VISIBLE_DEVICES=0 python generate.py --dataset hotpotqa --target llama-2-7b-chat-hf --pos_num 2 --neg_num 6 --task qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=0 python generate.py --dataset hotpotqa --target llama-2-7b-chat-hf --pos_num 2 --neg_num 8 --task qa --promptfile myprompt --nums 500 
...
# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-7b-chat-hf --pos_num 2 --neg_num 8 --task doc_qa --promptfile myprompt --nums 500 
...
# python evaluate_result.py --data_path ./results/hotpotqa/500/qa/llama-2-7b-chat-hf_pos_2_neg_0.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/qa/llama-2-7b-chat-hf_pos_2_neg_2.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/qa/llama-2-7b-chat-hf_pos_2_neg_4.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/qa/llama-2-7b-chat-hf_pos_2_neg_6.json
python evaluate_result.py --data_path ./results/hotpotqa/500/qa/llama-2-7b-chat-hf_pos_2_neg_8.json



# python evaluate_result.py --data_path ./results/hotpotqa/500/doc_qa/llama-2-7b-chat-hf_pos_2_neg_0.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/doc_qa/llama-2-7b-chat-hf_pos_2_neg_2.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/doc_qa/llama-2-7b-chat-hf_pos_2_neg_4.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/doc_qa/llama-2-7b-chat-hf_pos_2_neg_6.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/doc_qa/llama-2-7b-chat-hf_pos_2_neg_8.json



# python evaluate_result.py --data_path ./results/hotpotqa/500/rewrite_qa/llama-2-7b-chat-hf_pos_2_neg_0.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/rewrite_qa/llama-2-7b-chat-hf_pos_2_neg_2.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/rewrite_qa/llama-2-7b-chat-hf_pos_2_neg_4.json
# CUDA_VISIBLE_DEVICES=1 python evaluate_result.py --data_path ./results/hotpotqa/500/rewrite_qa/llama-2-7b-chat-hf_pos_2_neg_6.json
# CUDA_VISIBLE_DEVICES=1 python evaluate_result.py --data_path ./results/hotpotqa/500/rewrite_qa/llama-2-7b-chat-hf_pos_2_neg_8.json



# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 0 --task qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 2 --task qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 4 --task qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=0 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 6 --task qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=0 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 8 --task qa --promptfile myprompt --nums 500 

# CUDA_VISIBLE_DEVICES=0 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 0 --task doc_qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=0 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 2 --task doc_qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=0 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 4 --task doc_qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 6 --task doc_qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 8 --task doc_qa --promptfile myprompt --nums 500 

# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 0 --task rewrite_qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 2 --task rewrite_qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 4 --task rewrite_qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 6 --task rewrite_qa --promptfile myprompt --nums 500 
# CUDA_VISIBLE_DEVICES=1 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 8 --task rewrite_qa --promptfile myprompt --nums 500 


# python evaluate_result.py --data_path ./results/hotpotqa/500/qa/llama-2-13b-chat-hf_pos_2_neg_0.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/qa/llama-2-13b-chat-hf_pos_2_neg_2.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/qa/llama-2-13b-chat-hf_pos_2_neg_4.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/qa/llama-2-13b-chat-hf_pos_2_neg_6.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/qa/llama-2-13b-chat-hf_pos_2_neg_8.json

# python evaluate_result.py --data_path ./results/hotpotqa/500/doc_qa/llama-2-13b-chat-hf_pos_2_neg_0.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/doc_qa/llama-2-13b-chat-hf_pos_2_neg_2.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/doc_qa/llama-2-13b-chat-hf_pos_2_neg_4.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/doc_qa/llama-2-13b-chat-hf_pos_2_neg_6.json
# python evaluate_result.py --data_path ./results/hotpotqa/500/doc_qa/llama-2-13b-chat-hf_pos_2_neg_8.json
