...
# CUDA_VISIBLE_DEVICES=0 python generate.py --dataset hotpotqa --target llama-2-13b-chat-hf --pos_num 2 --neg_num 2 --task query_rewrite --promptfile myprompt --nums 500 
